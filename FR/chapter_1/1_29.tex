...
\end{equation}
%
Nous démontrons de quatre façons différentes (deux sont en annexe) que 
%
\begin{equation}
...
\begin{align}
    ...
    \Bigl(\bigl(1729^{1729}\bigr)^{1729}\Bigr)^{1729} &\equiv  \bigl(12^{1729}\bigr)^{1729} \equiv 12 \pmod{17},
    %&\hspace{0.25em} \vdots\nonumber
\end{align}
%
...
rapide. Sans l'un de ces outils, résoudre les congruences est beaucoup plus difficile et dépend de cas particuliers. %
Les deux autres preuves, ajoutées en annexe, servent de prétexte à un passage en revue des autres concepts et méthodes %
