...
les multiples impairs de $7$ inférieurs ou égaux à $99$, en notant bien (ci-dessous entre crochets) %
chaque contribution: 
%
\begin{equation}
...
\end{equation}
%
Gardons bien à l'esprit que $49 = 7^2$ contribue deux fois.
